const featuredTestimonial = {
  ...
  export default function Testimonials() {
    return (
      <div className="relative isolate bg-neutral-950 pb-16 pt-16 sm:pt-32">
        <div
          aria-hidden="true"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-xl text-center">
            <h2 className="text-lg font-semibold leading-8 tracking-tight text-sky-300">Our Trust</h2>
