      ...
      <div className="bg-neutral-950 py-16">
        <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
          <div className="mx-auto max-w-2xl">
            <h2 className="text-3xl font-bold tracking-tight text-sky-900 sm:text-4xl">Meet our team</h2>
          ...
          >
            {people.map((person) => (
              <li key={person.name}>
                ...
                <h3 className="mt-6 text-base font-semibold leading-7 tracking-tight text-sky-50">{person.name}</h3>
